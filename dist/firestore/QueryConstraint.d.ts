...
export type QueryConstraint = QueryConstraintAndOr | QueryConstraintWhere | QueryConstraintOrderBy | QueryConstraintLimit | QueryConstraintLimitToLast | QueryConstraintStartAtSnapshot | QueryConstraintStartAtValues | QueryConstraintStartAfterSnapshot | QueryConstraintStartAfterValues | QueryConstraintEndAtSnapshot | QueryConstraintEndAtValues | QueryConstraintEndBeforeSnapshot | QueryConstraintEndBeforeValues | QueryConstraintSelect;
export type RestQueryConstraint = QueryConstraintAndOr | QueryConstraintEndAtValues | QueryConstraintEndBeforeValues | QueryConstraintLimit | QueryConstraintOffset | QueryConstraintOrderBy | QueryConstraintSelect | QueryConstraintStartAfterValues | QueryConstraintStartAtValues | QueryConstraintWhere;
