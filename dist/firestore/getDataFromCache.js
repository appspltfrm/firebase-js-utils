...
exports.getDataFromCache = void 0;
const tslib_1 = require("tslib");
const firestore_1 = require("firebase/firestore");
const DocumentReference_1 = require("./DocumentReference");
const Query_1 = require("./Query");
function getDataFromCache(docOrQuery, options) {
    return (0, tslib_1.__awaiter)(this, void 0, void 0, function* () {
        if (Query_1.Query.isInstance(docOrQuery)) {
            if (Query_1.Query.isClient(docOrQuery)) {
                return (yield (0, firestore_1.getDocsFromCache)(docOrQuery)).docs.map(snapshot => snapshot.data(options));
            }
            else {
            ...
            if (DocumentReference_1.DocumentReference.isClient(docOrQuery)) {
                return (yield (0, firestore_1.getDocFromCache)(docOrQuery)).data(options);
            }
            else {
