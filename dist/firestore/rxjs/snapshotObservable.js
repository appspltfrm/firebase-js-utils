    ...
    return new rxjs_1.Observable(subscriber => {
        if (Query_1.Query.isInstance(docOrQuery)) {
            if (Query_1.Query.isClient(docOrQuery)) {
                const unsubscribe = (0, firestore_1.onSnapshot)(docOrQuery, options !== null && options !== void 0 ? options : {}, snapshot => subscriber.next(snapshot), error => subscriber.error(error));
                return () => unsubscribe();
            }
            else {
