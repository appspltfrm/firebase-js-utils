import { endAt, endBefore, limit, limitToLast, orderBy, query as queryClient, startAfter, startAt, where } from "firebase/firestore";
import { Query } from "./Query";
export function getQuery(query, ...queryConstraints) {
