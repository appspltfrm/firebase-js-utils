...
//#region Legacy reference implementation (verbatim)

type Transliterate = (input: string) => string;

function legacySplit(input: string, transliterate: Transliterate) {
...
function legacyGenerate(input: string, transliterate: Transliterate, mode: "index" | "query") {
