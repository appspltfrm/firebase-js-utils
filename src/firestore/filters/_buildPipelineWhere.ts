...
import {combineAnd, PipelineExpr} from "./_pipelineExpr.js";
 ...
 */
export function buildPipelineWhere(filters: Filter.SpecRequired[], expr: PipelineExpr, transliterate: Transliterate): any | undefined {
...
export function resolveFieldName(filter: Filter.SpecRequired): string {
...
export function resolveValue(filter: Filter.SpecRequired): any {
...
function buildCondition(filter: Filter.SpecRequired, expr: PipelineExpr, transliterate: Transliterate): any | undefined {
 ...
 * `dataField`).
 */
export function buildFieldCondition(operator: FilterOperator, type: FilterFieldType, field: any, value: any, expr: PipelineExpr, transliterate: Transliterate): any | undefined {
 ...
 */
function buildTextCondition(operator: FilterOperator, field: any, value: any, transliterate: Transliterate): any | undefined {
...
function buildTextArrayCondition(operator: FilterOperator, field: any, value: any): any | undefined {
...
function buildNumberCondition(operator: FilterOperator, field: any, value: any): any | undefined {
