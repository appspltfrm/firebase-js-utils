...
export async function getSnapshotsFromCache<T extends DocumentData = any>(query: QueryClient<T>): Promise<QueryDocumentSnapshotClient<T>[]>;

export async function getSnapshotsFromCache<T extends DocumentData = any>(query: QueryAdmin<T>): Promise<QueryDocumentSnapshotAdmin<T>[]>;
